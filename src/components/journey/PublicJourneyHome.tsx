...
export default function PublicJourneyHome(){return <main id="main-content" className="public-journey">
  ...
  <section className="public-scale" aria-labelledby="scale-heading">
    <div><p>Scale the flock</p><h2 id="scale-heading">More data? Add Ducklings.</h2><span>Each Duckling is another compute node. The Flight plan stays the same while more workers share the load.</span></div>
