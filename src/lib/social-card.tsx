...
export function socialCard(){
  ...
  const facts=["83 source files","88k observations","Live Dives"];
  ...
  return new ImageResponse(
    <div style={{width:"100%",height:"100%",display:"flex",background:"#f8efea",color:"#3f2928",fontFamily:"Arial, sans-serif",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{display:"flex",position:"absolute",left:"64px",top:"146px",width:"780px",flexDirection:"column"}}>
        <div style={{display:"flex",fontFamily:"Georgia, serif",fontSize:"65px",lineHeight:1,letterSpacing:"-2px",color:"#7d3034"}}>House data,</div>
        <div style={{display:"flex",fontFamily:"Georgia, serif",fontSize:"65px",lineHeight:1,letterSpacing:"-2px",color:"#7d3034",marginTop:"8px"}}>made explorable.</div>
        <div style={{display:"flex",fontSize:"23px",color:"#816b68",marginTop:"28px"}}>Live, auditable Victorian house-sales analytics.</div>
      </div>
