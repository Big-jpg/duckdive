export const vehicleMarketContract={
  ...
  grains:{current:"One row per source listing ID in the latest COMPLETE observation run",history:"One row per COMPLETE observation run and stable listing key",runQuality:"One row per attempted observation run"},
...
export const vehicleMarketPublicContract={
  ...
  grains:[
    {name:"Current listings",grain:"One row per source listing ID in the latest COMPLETE observation"},
    {name:"Observation history",grain:"One row per source listing ID per COMPLETE observation"},
