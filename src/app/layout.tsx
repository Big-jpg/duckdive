...
export const metadata: Metadata = {
  ...
  description: "Owner-scoped governed analytics for importing data, building Dives, and sharing inspectable answers.",
  keywords: ["governed analytics", "data visualisation", "CSV analysis", "embedded analytics"],
  creator: "DuckDive",
  publisher: "DuckDive",
  category: "technology",
