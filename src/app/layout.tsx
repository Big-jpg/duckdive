...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_AU",
    title: "DuckDive — Victorian House Data, Made Explorable",
    description: "Explore live interactive analytics across an auditable Victorian house-sales estate.",
    images: [{url:"/opengraph-image",width:1200,height:630,alt:"DuckDive — Victorian house data, made explorable"}],
  },
  twitter: {
